 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Mar 07 12:55:32 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME matl_impl_reg
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void matl_impl_reg_Outputs_wrapper(const real_T *u0,
			real_T *y0);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    matl_impl_reg_Outputs_wrapper(u0, y0);
